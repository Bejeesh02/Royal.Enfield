...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="logo.avif" alt="Avatar Logo" style="width:200px;"
                    class="img img-fulid"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="royal.html">Home</a>
                    </li>
                </ul>
    ...
    <div class="container" style="background-color: black; color: white; margin-top: 10px; margin-bottom: 10px; padding-bottom: 20px;
  padding-top: 20px; border-radius: 25px;">
        <form class="row g-3">
            <div class="col-md-6">
